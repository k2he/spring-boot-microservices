...
public class HttpCookieOAuth2AuthorizationRequestRepository implements AuthorizationRequestRepository<OAuth2AuthorizationRequest> {
    ...
    // TODO: need check why response Cookie is the not the one we set the request. So this is
    // is a temp walk around. For some reason microservice doesn't work well with Cookies
